/****************************************************************************
** Meta object code from reading C++ file 'api_caller.h'
**
...
#error "The header file 'api_caller.h' doesn't include <QObject>."
...
void ApiCaller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->post((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ApiCaller::*)(const QString & )>(_a, &ApiCaller::responseReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ApiCaller::*)(const QString & )>(_a, &ApiCaller::errorOccurred, 1))
            return;
    }
}
...
// SIGNAL 0
void ApiCaller::responseReceived(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ApiCaller::errorOccurred(const QString & _t1)
{
